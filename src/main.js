...
function renderJobsContent(){
  ...
  if(!o.length&&!activeBookings.length)return filterBar+renderEmptyState('Jobs','Accepted jobs and new offers will appear here')
